...
.skill-table-grid {
  display: grid;
  grid-template-columns: 240px minmax(360px, 1fr) 96px 140px 96px;
  align-items: center;
  gap: 18px;
}
...
.skill-detail-drawer .el-drawer__body {
  padding: 0 24px 24px;
...
.skill-file-mini-action:hover {
  background: #dcecff;
}

.skill-file-mini-action.danger {
  color: #f56c6c;
}

.skill-file-mini-action.danger:hover {
  background: #fff1f1;
}
...
.skill-file-editor :deep(.el-textarea__inner) {
  height: 100%;
  min-height: 0;
  padding: 16px;

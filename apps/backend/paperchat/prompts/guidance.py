...
GUIDANCE_STATUS_DESCRIPTIONS = {
    ...
    "ready_for_draft": "信息已基本充分，可以手动生成研究方案。",
    "draft_ready": "研究方案已经生成，可以继续迭代。",
}
...
def build_guidance_prompt(
    *,
    ...
    return (
        ...
        f"已有方案：{json.dumps(existing_draft, ensure_ascii=False) if existing_draft else 'null'}\n\n"
...
def build_draft_prompt(*, conversation_title: str, transcript: str, guidance: dict) -> str:
    return (
        "请根据下面的会话和 guidance 信息生成研究方案 JSON。"
        "\n\n"
